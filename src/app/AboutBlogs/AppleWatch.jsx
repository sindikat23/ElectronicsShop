...
const AppleWatch = () => {
    return (
        <div className='bg-[rgba(249,249,249,1)]'>
            <div className='container mx-auto flex py-20 justify-between items-center gap-10'>
                <div className='w-1/2'>
                    ...
                    <p className='text-[16px] font-medium w-3/4 text-[rgba(76,76,76,1)] py-2'>Featured packed  at a batter value than over pawerful sensors to manitor your fitness</p>
